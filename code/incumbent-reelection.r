...
v5$oth <- v5$left <- v5$prd <- v5$pri <- v5$pan <- 0
v5$dmajcoal <- 0 # will indicate major party coalitions
#
rm(tmp, tmp.orig)
#
# change prd/morena to left labels
...
v5$left[sel1][sel] <- v5$v[sel1][sel]
v5$v[sel1][sel] <- 0;
v5$l[sel1][sel] <- "0";
v5$status[sel1][sel] <- "done"
#
...
v5$status[sel1][sel] <- "done"
#
## # morena is all left now, has no column
## sel1 <- which(is.na(v5$status))
...
v5$pan[sel][sel1] <- v5$v[sel][sel1] / 3;
v5$pri[sel][sel1] <- v5$v[sel][sel1] / 3;
v5$left[sel][sel1] <- v5$v[sel][sel1] / 3;
v5$v[sel][sel1] <- 0;
v5$l[sel][sel1] <- "0";
v5$status[sel][sel1] <- "done"
...
v5$pan[sel][sel1] <- v5$v[sel][sel1] / 3;
v5$pri[sel][sel1] <- v5$v[sel][sel1] / 3;
v5$prd[sel][sel1] <- v5$v[sel][sel1] / 3;
v5$v[sel][sel1] <- 0;
v5$l[sel][sel1] <- "0";
v5$status[sel][sel1] <- "done"
v5$dmajcoal[sel][sel1] <- 1
...
v5$prd[sel] <- v5$v[sel] / 2;
v5$v[sel] <- 0; v5$l[sel] <- "0";
v5$status[sel] <- "done"
v5$dmajcoal[sel] <- 1
#
# pan-prd to pan (pue2010 pue2013)
sel <- which(v5$status=="majors" & v5$edon==21)
v5$pan[sel] <- v5$v[sel];
v5$v[sel] <- 0;
v5$l[sel] <- "0";
v5$status[sel] <- "done"
...
sel <- which(v5$status=="majors" & v5$edon==23)
v5$left[sel] <- v5$v[sel];
v5$v[sel] <- 0;
v5$l[sel] <- "0";
v5$status[sel] <- "done"
v5$dmajcoal[sel] <- 1
#
# pan-prd to prd (gue2015 oax2016)
sel <- which(v5$status=="majors" & (v5$edon==12 | v5$edon==20) & (v5$yr==2015 | v5$yr==2016)) 
v5$prd[sel] <- v5$v[sel];
v5$v[sel] <- 0;
v5$l[sel] <- "0";
v5$status[sel] <- "done"
v5$dmajcoal[sel] <- 1
#
# pan-prd to left (hgo2011 mic2015 oax2010 oax2013 zac2013, zac2016)
sel <- which(v5$status=="majors" & (v5$edon==13 | v5$edon==16 | v5$edon==20 | v5$edon==32) & v5$yr<2018) 
v5$pan[sel] <- v5$v[sel] / 2; 
v5$left[sel] <- v5$v[sel] / 2;
v5$v[sel] <- 0;
v5$l[sel] <- "0";
v5$status[sel] <- "done"
v5$dmajcoal[sel] <- 1
