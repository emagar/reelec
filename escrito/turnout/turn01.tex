...
\usepackage{interval}                        % formats math intervals
\intervalconfig{soft open fences}            % uses parentheses for open interval fences
\newcommand{\interv}{\interval[scaled=\big]} % short for interval w slightly bigger fences

\newcommand{\mc}{\multicolumn}
\newcommand{\vn}[1]{\vnform{#1}}      % short for variable name formating
% see https://tex.stackexchange.com/questions/482743/typesetting-multi-letter-variable-names-in-math-mode
\newcommand{\vnform}[1]{\mathsf{#1}}  % "look": sans serif/upright
...
\subsection{For the appendix}
% \begin{table}
%   \caption{Regression discontinuity analysis. Method of estimation: MCMC.}
\resizebox{.5\textwidth}{!}{
\begin{tabular}{@{\extracolsep{5pt}}clD{.}{.}{2}D{,}{,}{-3}}
\\[-1.8ex]\hline 
\hline \\[-1.8ex] 
$\vn{neg}$ & Coefficient         & \mc{1}{r}{\text{Estimate}} & \mc{1}{c}{95\%~interval} \\ \hline \\[-1.8ex]  
& \multicolumn{3}{c}{\textbf{PAN 1997--2023} ($N=4,758$)}  \\ \\[-2.5ex]  
...
& \multicolumn{3}{c}{\textbf{PRI 1997--2023} ($N=7,293$)} \\ \\[-2.5ex]  
...
& \multicolumn{3}{c}{\textbf{Left 1997--2023} ($N=2,889$)} \\ \\[-2.5ex]  
...
& \multicolumn{3}{c}{\textbf{Left 2018--2023} ($N=394$)} \\ \\[-2.5ex]  
