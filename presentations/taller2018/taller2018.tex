...
\title[Reelección consecutiva]{¿Otro clavo en el ataúd \\ del excepcionalismo mexicano?}
\subtitle{La remoción de la no reelección consecutiva}
\author[Magar-Moreno]{Eric Magar y Alejandro Moreno}
\institute[ITAM]{ITAM}
\date[18-may-2018]{\small{Taller Casa de la Marquesa} \\ 18 de mayo 2018}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\frame {                      % SLIDE
  \frametitle{El sistema electoral mexicano}
  El cambio institucional ha sido continuo  (Molinar 1991)
  \begin{description}
%  \item Some PR compensation (1964)
  \item[1950s] centralización  
  \item[1964] RP compensatoria
  \item[1979] reducción de las barreras de entrada
  \item[1994] RP en el Senado
  \item[1997] regulador electoral independiente
  \item[$\ldots$]
  \end{description}
  \bigskip \pause
  Constante: \alert{prohibición de reelección consecutiva} general desde 1934
    }
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\frame {                      % SLIDE
...
\frame {                      % SLIDE
  ...
  \bigskip
  \begin{itemize}
  \item Dip. federales pueden reelegirse hasta 4 periodos consecutivos
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\frame {                      % SLIDE
  \frametitle{El 1 de julio de 2018}

  \begin{columns}
  \begin{column}{0.5\textwidth}

    \begin{block}{Reelección de diputados solamente}
      Aguascalientes,
      Durango,
      Hidalgo,
      Tlaxcala,
    ...
    \bigskip %\pause
    \begin{block}{Reelección de alcaldes solamente}
      Coahuila,
      Quintana Roo,
      Tamaulipas
    \end{block}
      ...
      \bigskip %\pause
      \begin{block}{Eligen diputados y alcaldes sin reelección}
        Federales, 
        Cd de México,
        Puebla,
        Sonora
  ...
  \end{column}
      ...
      %\pause
      \begin{column}{0.5\textwidth}
        \begin{block}{Reelección de diputados y de alcaldes}
          Baja California Sur,
          Campeche,
          Colima,
          Chiapas,
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\frame {                      % SLIDE
  \frametitle{Alcaldes 2018: solicitudes de licencia reportadas en prensa}
  
  \begin{itemize}
  \item BCS
    \begin{itemize}
    \item Los Cabos, Loreto
    \item 3 municipios más, no
    \end{itemize}
  \item Jalisco
    \begin{itemize}
    \item Ahualulco, Puerto Vallarta, Tamazula, Tlajomulco, Tlaquepaque, Tuxpan, Zapopan
    \item 119 no
    \end{itemize}
  \item Michocán
    \begin{itemize}
    \item Buenavista, Huetamo, Morelia, Morelos, Pajacuarán, Parácuaro, Pátzcuaro, La Piedad, Queréndaro, Sahuayo, Tangancícuaro, Taretan, Tarímbaro, Zacapu
    \item 99 no
    \end{itemize}
  \item Morelos
    \begin{itemize}
    \item Cuautla, Jiutepec
    \item 31 no
    \end{itemize}
  \item Oaxaca
    \begin{itemize}
    \item Oaxaca, San Felipe Jalapa, San Lucas Ojitlán
    \item 122 no
    \end{itemize}
  \end{itemize}
  }
...
\frame {                      % SLIDE
  ...
  \item Por ende, el juego es más complejo, amenazas bi-direccionales
  \end{itemize}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\frame {                      % SLIDE
  ...
  \begin{columns}
   \begin{column}{0.6\textwidth}
     Encuesta preelectoral de mayo incluyó reactivos de \emph{name recognition} (Cain, Ferejohn, Fiorina 1987)
   \end{column}
   
   \begin{column}{0.4\textwidth}
   \includegraphics[width=\columnwidth]{../../pics/portdaFinanciero2.png}
   \end{column}
  \end{columns}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\frame {                      % SLIDE
  \frametitle{Doble fraseo}
   \includegraphics[width=\columnwidth]{../../pics/pregs2122.png}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\frame {                      % SLIDE
  \frametitle{Doble fraseo}
   \includegraphics[width=\columnwidth]{../../pics/preg25.png}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\frame {                      % SLIDE
...
\frame {                      % SLIDE
  ...
  \begin{itemize}
  \item Resultados sustanciales y consistentes con efecto de ocupante
  \item Diseño mejorable para un estudio de 2018
  \item La reelección consecutiva tiene enorme potencial para remozar la representación
  \item Si se cumple o no el potencial = prometedora agenda en política mexicana
  \end{itemize}
